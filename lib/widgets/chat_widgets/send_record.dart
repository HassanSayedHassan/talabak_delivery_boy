...
import 'package:talabak_delivery_boy/widgets/chat_widgets/play_record.dart';
...
class SendRecord extends StatefulWidget {
  ...
  SendRecord(this.current_uid,this.other_uid,this.channelId,this.current_email,this.name,this.uid,this.profile_image,{localFileSystem,Key key, @required this.notifyParent}):
